...
if has("autocmd")
	...
	autocmd BufNewFile,BufRead *.txt setf txt
        autocmd Filetype text,changelog,change,markdown,latex,tex,md setlocal spell
    ...
    augroup pyDocAutoComplete
	autocmd!
	autocmd Filetype python,py  inoremap <buffer> """ """<CR>"""<ESC>ko
    augroup END
...
"Backup {{{1
set backup
set backupdir=~/.local/share/nvim/nvim-tmp
set directory=~/.local/share/nvim/nvim-tmp,~/.local/share/nvim/tmp/
set writebackup
"-----------------------------------------------------------
...
nnoremap <silent> <M-F10> :BufExplorer<CR>
...
"since we remapped <C-l> replace the functionality
